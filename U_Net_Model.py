...
class NeuralNetwork():
    ...
    def attach_summary(self, sess):
        ...
        filepath = os.path.join(os.getcwd(), self.logs_dir_name, (self.nn_name+'_'+timestamp))
    ...
    def save_model(self, sess):
        ...
        if not os.path.isdir(os.path.join(os.getcwd(), self.save_dir_name)):
            os.mkdir(self.save_dir_name)
        filepath = os.path.join(os.getcwd(), self.save_dir_name , self.nn_name+'_params.npy')
    ...
    def load_parameters(self, filename):
        ...
        filepath = os.path.join(os.getcwd(), self.save_dir_name, filename+'_params.npy')
